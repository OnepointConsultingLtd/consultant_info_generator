...
CREATE TABLE PUBLIC.TB_DIFFERENTIATION_QUESTION_RESPONSE (
	ID INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE PUBLIC.TB_DIFFERENTIATION_QUESTION_RESPONSE_ASSIGNMENT (
	ID INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
	CONSULTANT_ID INTEGER NOT NULL,
	DIFFERENTIATION_QUESTION_RESPONSE_ID INTEGER NOT NULL,
	CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
	UPDATED_AT TIMESTAMP NULL,
	CONSTRAINT CONSULTANT_ID
		FOREIGN KEY (CONSULTANT_ID) REFERENCES PUBLIC.TB_CONSULTANT (ID)
		MATCH SIMPLE ON UPDATE NO ACTION ON DELETE CASCADE,
	CONSTRAINT DIFFERENTIATION_QUESTION_RESPONSE_ID
		FOREIGN KEY (DIFFERENTIATION_QUESTION_RESPONSE_ID) REFERENCES PUBLIC.TB_DIFFERENTIATION_QUESTION_RESPONSE (ID)
		MATCH SIMPLE ON UPDATE NO ACTION ON DELETE CASCADE
);
