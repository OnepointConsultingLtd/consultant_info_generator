...
values((select id from TB_SESSION where SESSION_ID='1234'), (select id from TB_CATEGORY_QUESTION order by id limit 1));
...
and CATEGORY_QUESTION_ID = (select id from TB_CATEGORY_QUESTION order by id limit 1)), 
