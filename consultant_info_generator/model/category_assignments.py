...
class CategoryAssignment(BaseModel):
    ...
    reason: str = Field(description="The reason for the assignment, why the category was assigned to the consultant")
...
class ProfileCategoryAssignments(BaseModel):
    ...
    profile_category_assignments: list[ProfileCategoryAssignment] = Field(description="A list of profile category assignments")